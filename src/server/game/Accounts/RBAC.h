...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_GOBJECT_GROUP                         = 3008,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_HELP                    = 3009,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_CREATE                  = 3010,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_USE                     = 3011,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_ADD                     = 3012,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_SCAN                    = 3013,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_ADDNEAR                 = 3014,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_REMOVE                  = 3015,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_DISSOLVE                = 3016,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_DELETE                  = 3017,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_INFO                    = 3018,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_LIST                    = 3019,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_TARGET                  = 3020,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_CHECK                   = 3021,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_STATUS                  = 3022,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_CAPTURE                 = 3023,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_RECALC                  = 3024,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_SYNC                    = 3025,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_MOVE                    = 3026,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_TURN                    = 3027,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_RELOCATE                = 3028,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_RELOAD                  = 3029,
    RBAC_PERM_COMMAND_GOBJECT_GROUP_CLEANUP                 = 3030,
    RBAC_PERM_COMMAND_RP_PHASE                              = 3031,
    RBAC_PERM_COMMAND_RP_PHASE_HELP                         = 3032,
    RBAC_PERM_COMMAND_RP_PHASE_CREATE                       = 3033,
    RBAC_PERM_COMMAND_RP_PHASE_LIST                         = 3034,
    RBAC_PERM_COMMAND_RP_PHASE_INFO                         = 3035,
    RBAC_PERM_COMMAND_RP_PHASE_ENTER                        = 3036,
    RBAC_PERM_COMMAND_RP_PHASE_LEAVE                        = 3037,
    RBAC_PERM_COMMAND_RP_PHASE_INVITE                       = 3038,
    RBAC_PERM_COMMAND_RP_PHASE_REVOKE                       = 3039,
    RBAC_PERM_COMMAND_RP_PHASE_ARCHIVE                      = 3040,
    RBAC_PERM_COMMAND_RP_PHASE_RELOAD                       = 3041,
    RBAC_PERM_COMMAND_RP_PHASE_SPAWN_INFO                   = 3042,
    RBAC_PERM_COMMAND_RP_PHASE_SPAWN_ASSIGN                 = 3043,
    RBAC_PERM_COMMAND_RP_PHASE_SPAWN_CLEAR                  = 3044,
    RBAC_PERM_COMMAND_RP_PHASE_ALL_PHASES                   = 3045,
    RBAC_PERM_COMMAND_RP_PHASE_SET                          = 3046,
    RBAC_PERM_COMMAND_RP_PHASE_SET_PUBLIC                   = 3047,
    RBAC_PERM_COMMAND_RP_PHASE_SET_OWNER                    = 3048,
    RBAC_PERM_COMMAND_RP_PHASE_SET_ROLE                     = 3049,
    RBAC_PERM_COMMAND_RP_PHASE_SET_SPAWN                    = 3050,
    RBAC_PERM_COMMAND_RP_PHASE_SET_ENTER_SPAWN              = 3051,
    RBAC_PERM_COMMAND_RP_PHASE_SET_NAME                     = 3054,
    RBAC_PERM_COMMAND_RP_PHASE_GOTO                         = 3052,
    RBAC_PERM_COMMAND_LOOKUP_RP_PHASE                       = 3053,

    // NobleNext GobBlueprint (.gobject blueprint *) — 3055–3063
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT                     = 3055,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_HELP                = 3056,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_LIST                = 3057,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_INFO                = 3058,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_NEW                 = 3059,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_UPDATE              = 3060,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_SPAWN               = 3061,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_DELETE              = 3062,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_RENAME              = 3063,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_SET_PUBLIC          = 3064,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_MEMBER              = 3065,
    RBAC_PERM_COMMAND_GOBJECT_BLUEPRINT_STAFF               = 3066,
