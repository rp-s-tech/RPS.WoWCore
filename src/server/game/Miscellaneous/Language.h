...
//                                        = 716, see LANG_PINFO_ACC_LASTLOGIN
    ...
    LANG_COMMAND_CUSTOMNPC_HELP                   = 11060,
    LANG_COMMAND_CUSTOMNPC_ADD_HELP               = 11061,
    LANG_COMMAND_CUSTOMNPC_DELETE_HELP            = 11062,
    LANG_COMMAND_CUSTOMNPC_SPAWN_HELP             = 11063,
    LANG_COMMAND_CUSTOMNPC_SPAWN_TEMP_HELP        = 11064,
    LANG_COMMAND_CUSTOMNPC_SET_NAME_HELP          = 11065,
    LANG_COMMAND_CUSTOMNPC_SET_SUBNAME_HELP       = 11066,
    LANG_COMMAND_CUSTOMNPC_SET_FACE_HELP          = 11067,
    LANG_COMMAND_CUSTOMNPC_SET_RACE_HELP          = 11068,
    LANG_COMMAND_CUSTOMNPC_SET_GENDER_HELP        = 11069,
    LANG_COMMAND_CUSTOMNPC_SET_DISPLAYID_HELP     = 11070,
    LANG_COMMAND_CUSTOMNPC_SET_SCALE_HELP         = 11071,
    LANG_COMMAND_CUSTOMNPC_SET_GUILD_HELP         = 11072,
    LANG_COMMAND_CUSTOMNPC_SET_TAMEABLE_HELP      = 11073,
    LANG_COMMAND_CUSTOMNPC_EQUIP_ARMOR_HELP       = 11074,
    LANG_COMMAND_CUSTOMNPC_EQUIP_WEAPON_HELP      = 11075,
    LANG_COMMAND_CUSTOMNPC_UNEQUIP_ARMOR_HELP     = 11076,
    LANG_COMMAND_CUSTOMNPC_UNEQUIP_WEAPON_HELP    = 11077,
    LANG_COMMAND_CUSTOMNPC_REMOVE_VARIATION_HELP  = 11078,
    LANG_COMMAND_CUSTOMNPC_CLONE_HELP             = 11079,
    LANG_COMMAND_CUSTOMNPC_CLONE_TARGET_HELP      = 11080,
    LANG_COMMAND_CUSTOMNPC_APPLY_HELP             = 11081,
    LANG_COMMAND_CUSTOMNPC_RELOAD_HELP            = 11082,
    LANG_COMMAND_CUSTOMNPC_IMPORT_HELP            = 11083,
    LANG_COMMAND_CUSTOMNPC_LIST_HELP              = 11084,
    LANG_COMMAND_CUSTOMNPC_SET_STANDSTATE_HELP    = 11085,
    LANG_COMMAND_CUSTOMNPC_FACE_LIST_HELP       = 11086,
    LANG_COMMAND_CUSTOMNPC_FACE_CHOICES_HELP    = 11087,
    LANG_COMMAND_CUSTOMNPC_MODEL_LIST_HELP      = 11088,
    LANG_COMMAND_CUSTOMNPC_MODEL_ADD_HELP       = 11089,
    LANG_COMMAND_CUSTOMNPC_MODEL_COPY_HELP      = 11090,
    LANG_COMMAND_CUSTOMNPC_MODEL_APPLY_HELP     = 11091,
    LANG_COMMAND_CUSTOMNPC_CLONE_CUSTOM_HELP    = 11092,
    LANG_COMMAND_CUSTOMNPC_CLONE_ENTRY_HELP     = 11093,
    LANG_COMMAND_CUSTOMNPC_REFRESH_HELP         = 11094,
    LANG_COMMAND_CUSTOMNPC_DIAGNOSE_HELP        = 11095,
    LANG_COMMAND_CUSTOMNPC_EQUIP_COPY_HELP      = 11096,
    ...
    // NobleNext GobBlueprint command help (trinity_string 11121-11128, 11153-11155)
    LANG_COMMAND_GOBBLUEPRINT_HELP                = 11121,
    LANG_COMMAND_GOBBLUEPRINT_LIST_HELP           = 11122,
    LANG_COMMAND_GOBBLUEPRINT_INFO_HELP           = 11123,
    LANG_COMMAND_GOBBLUEPRINT_NEW_HELP            = 11124,
    LANG_COMMAND_GOBBLUEPRINT_UPDATE_HELP         = 11125,
    LANG_COMMAND_GOBBLUEPRINT_SPAWN_HELP          = 11126,
    LANG_COMMAND_GOBBLUEPRINT_DELETE_HELP         = 11127,
    LANG_COMMAND_GOBBLUEPRINT_RENAME_HELP         = 11128,
    LANG_COMMAND_GOBBLUEPRINT_SET_PUBLIC_HELP     = 11153,
    LANG_COMMAND_GOBBLUEPRINT_MEMBER_HELP         = 11154,
    LANG_COMMAND_GOBBLUEPRINT_STAFF_HELP          = 11155,
