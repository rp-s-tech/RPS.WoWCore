...
DB2Storage<ChrCustomizationBoneSetEntry>        sChrCustomizationBoneSetStore("ChrCustomizationBoneSet.db2", &ChrCustomizationBoneSetLoadInfo::Instance);
DB2Storage<ChrCustomizationCategoryEntry>       sChrCustomizationCategoryStore("ChrCustomizationCategory.db2", &ChrCustomizationCategoryLoadInfo::Instance);
DB2Storage<ChrCustomizationCondModelEntry>      sChrCustomizationCondModelStore("ChrCustomizationCondModel.db2", &ChrCustomizationCondModelLoadInfo::Instance);
DB2Storage<ChrCustomizationConversionEntry>     sChrCustomizationConversionStore("ChrCustomizationConversion.db2", &ChrCustomizationConversionLoadInfo::Instance);
...
DB2Storage<ChrCustomizationGlyphPetEntry>       sChrCustomizationGlyphPetStore("ChrCustomizationGlyphPet.db2", &ChrCustomizationGlyphPetLoadInfo::Instance);
...
DB2Storage<ChrCustomizationSkinnedModelEntry>   sChrCustomizationSkinnedModelStore("ChrCustomizationSkinnedModel.db2", &ChrCustomizationSkinnedModelLoadInfo::Instance);
...
uint32 DB2Manager::LoadStores(std::string const& dataPath, LocaleConstant defaultLocale)
{
    ...
    LOAD_DB2(sChrCustomizationBoneSetStore);
    LOAD_DB2(sChrCustomizationCategoryStore);
    LOAD_DB2(sChrCustomizationCondModelStore);
    LOAD_DB2(sChrCustomizationConversionStore);
    ...
    LOAD_DB2(sChrCustomizationGlyphPetStore);
    ...
    LOAD_DB2(sChrCustomizationSkinnedModelStore);
