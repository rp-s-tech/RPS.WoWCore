...
TC_GAME_API extern DB2Storage<ChrCustomizationCategoryEntry>      sChrCustomizationCategoryStore;
TC_GAME_API extern DB2Storage<ChrCustomizationCondModelEntry>     sChrCustomizationCondModelStore;
TC_GAME_API extern DB2Storage<ChrCustomizationConversionEntry>      sChrCustomizationConversionStore;
TC_GAME_API extern DB2Storage<ChrCustomizationGeosetEntry>          sChrCustomizationGeosetStore;
TC_GAME_API extern DB2Storage<ChrCustomizationGlyphPetEntry>      sChrCustomizationGlyphPetStore;
TC_GAME_API extern DB2Storage<ChrCustItemGeoModifyEntry>            sChrCustItemGeoModifyStore;
